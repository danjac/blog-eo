...
{{ image.img(url="/img/erich-von-daniken-gods-from-outer-space-cover-we-are-the-mutants-0.webp", description="La Dioj el Kosmo Fonto: We Are the Mutants", width=800, height=1070) }}
...
{{ image.img(url="/img/Chariots_Of_The_Gods.jpg", description="Ĉu Ĉaroj de la Dioj? Fonto: Wikipedia", width=210, height=350, class="float-left")}}
